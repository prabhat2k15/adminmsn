    <div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
      ...
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          <li class=" nav-item"><a href=""><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Order Management</span><span class="tag tag tag-primary tag-pill float-xs-right mr-2">*</span></a>
            <ul class="menu-content">
              <li class="active"><a href="/oms/view" data-i18n="nav.dash.main" class="menu-item">Dashboard</a>
              </li>
              <li><a href="/oms/invoice" data-i18n="nav.dash.main" class="menu-item">Invoices</a>
              </li>
            </ul>
          </li>
          <li class=" nav-item"><a href="#"><i class="icon-stack-2"></i><span data-i18n="nav.page_layouts.main" class="menu-title">Seller</span></a>
            <ul class="menu-content">
              <li><a href="/seller/view" data-i18n="nav.page_layouts.1_column" class="menu-item">Dashboard</a>
              </li>
              <li><a href="/seller/registerbrand" data-i18n="nav.page_layouts.2_columns" class="menu-item">Create</a>
              </li>
          ...
          <li class=" nav-item"><a href="#"><i class="icon-briefcase4"></i><span data-i18n="nav.project.main" class="menu-title">Store</span></a>
            <ul class="menu-content">
              <li><a href="/store/view" data-i18n="nav.invoice.invoice_template" class="menu-item">Create</a>
              </li>
