		...
		<div class="col-md-6 offset-md-3">
			<div class="card">
				...
				<div class="card-body collapse in">
					<div class="card-block">
						<div class="card-text">
							<!-- <p>$name, $address, $city, $state, $country, $pincode, $description. $email, $contact, $website</p> -->
						</div>
						<form class="form" action="create" method="POST">
							<div class="form-body">
								...
								<div class="form-group">
									...
									<div class="input-group">
										<label class="display-inline-block custom-control custom-radio ml-1">
											<input type="radio" name="type" value="ebo" checked class="custom-control-input">
											<span class="custom-control-indicator"></span>
											<span class="custom-control-description ml-0">EBO</span>
										</label>
										<label class="display-inline-block custom-control custom-radio">
											<input type="radio" name="type" value="mbo" class="custom-control-input">
											<span class="custom-control-indicator"></span>
											<span class="custom-control-description ml-0">MBO</span>
										</label>
										<label class="display-inline-block custom-control custom-radio">
											<input type="radio" name="type" value="sis" class="custom-control-input">
											<span class="custom-control-indicator"></span>
