            ...
            <div class="card-body">
                <div class="media">
                    ...
                    <div class="p-2 bg-cyan white media-body">
                        <h5>Brand</h5>
                        <h5 class="text-bold-400">{count($res)}</h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-8 col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Recent Sellers</h4>
            ...
            <div class="card-body">
                <div class="card-block">
                    <p class="m-0">Total Sellers:count<span class="float-xs-right"><a href="#" target="_blank">Seller Summary <i class="icon-arrow-right2"></i></a></span></p>
                </div>
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                        {for $i=0 to count($res)-1}
                            <tr><!-- portrait/small/avatar-s-4 -->
                                <td class="text-truncate">{$res[$i]->name}</td>
                                <td class="text-truncate">
                                    <span class="avatar avatar-xs"><img src="/src/app-assets/images/logo/ms.png" alt="avatar"></span> <span>{$res[$i]->company}</span>
                                </td>
                                <td class="text-truncate"><span class="tag tag-success">@ {$res[$i]->username}</span></td>
